...
object Day01: Day {
    ...
    fun calculateFuelRecursively(masses: List<Int>): Int {
        return masses.fold(0) { total, mass ->
            val fuelForMass = fuelFor(mass)
            total + fuelForMass
        }
    }

    private fun fuelFor(mass: Int): Int {
        return fuelFor(Pair(mass, 0))
    }

    private fun fuelFor(data: Pair<Int, Int>): Int {
