...
object Day04 : Day {
    ...
    data class Passport(
        private val byr: String? = null, // (Birth Year)
        private val iyr: String? = null, // (Issue Year)
        private val eyr: String? = null, // (Expiration Year)
        private val hgt: String? = null, // (Height)
        private val hcl: String? = null, // (Hair Color)
        private val ecl: String? = null, // (Eye Color)
        private val pid: String? = null, // (Passport ID)
        private val cid: String? = null  // (Country ID)
    ) {
        companion object {
...
fields and valid values. Continue to treat cid as optional. In your batch file, how many passports are valid?
 */