...
class Day6B: Day6Base() {
    companion object {
        @JvmStatic
        fun main(args: Array<String>) {
            val spaceData: List<String> = Helpers.loadOrbitData("/day6-input.txt")
            val graph: Graph = Day6B().createGraph(spaceData)
            val traverseCount = graph.traverseCount("YOU", "SAN")
            println("Transfers: $traverseCount") // 370
        }
    }
